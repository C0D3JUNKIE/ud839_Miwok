...
public class ColorsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    words.add(new Word("red", "weitti", R.drawable.color_red, R.raw.color_red));
    ...
    words.add(new Word("white", "kelelii", R.drawable.color_white, R.raw.color_white));
    words.add(new Word("dusty yellow", "topiise", R.drawable.color_dusty_yellow,
        R.raw.color_dusty_yellow));
    words.add(new Word("mustard yellow", "chiwite", R.drawable.color_mustard_yellow,
        R.raw.color_mustard_yellow));

    WordAdapter itemsAdapter = new WordAdapter(this, words, R.color.colors_activity_background);

    ListView listView = findViewById(R.id.lv_colors_word_view);
    ...
    listView.setOnItemClickListener(new OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
          mediaPlayer = MediaPlayer.create(ColorsActivity.this, word.getAudioPosition());
          mediaPlayer.start();
  ...
  protected void onStart() {
    super.onStart();
    Log.v("COLORS ACTIVITY", "State Change: onStartCalled");
  }

  @Override
  protected void onStop() {
    super.onStop();
    Log.v("COLORS ACTIVITY", "State Change: onStopCalled");
    releaseMediaPlayer();
  }
  ...
  protected void onDestroy() {
    super.onDestroy();
    Log.v("COLORS ACTIVITY", "State Change: onDestroyCalled");
  }
